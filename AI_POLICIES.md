...
| BANKER_KITTY | **ON** | the banker counts its OWN buried cards as known (its own information; MCBot's sampler already did, Memory did not) | 46% (n=300) then **54%** on fresh seeds (n=300) — pooled 299-301 = **49.8%** | kept on correctness grounds; the two blocks disagreeing by 8 points is itself a reminder that n=300 is not decisive |
