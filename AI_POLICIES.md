...
| `mc-vleaf-v11pair` | the hybrid using v11pair's value head | **32.5% vs mc** (39-81, n=120) | rejected, and predicted in advance: a pairwise-trained head has no absolute anchor, so it cannot rank leaves across states |
