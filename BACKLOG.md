...
Last re-derived: 2026-08-11 00:42 EDT.
...
- **Air:** the independent S4 point-banking replication remains sealed and
  healthy on eight workers. Last score-free heartbeat: 1,398/2,048 primary
...
| **P1 / repo integration cleanup** | Replace the long experimental PR stack with one reviewable integration on current `main`, without deleting run provenance. | PR #11 merged; #10/#12/#21/#25 closed; 16 remote branches pruned. Three clean merged routing worktrees/local refs were also removed. A ledger-loss audit restored nine source-required raw markers and added a regression test. **Left:** finish T4 source/results, build one clean integration branch, run the broad suite, merge, then close ancestors and audit local evidence worktrees before removal. | One current-main integration PR plus branch/worktree inventory | Every retained source path has a consumer; every removed branch is merged/superseded and owns no sole evidence bytes. |
