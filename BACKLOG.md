...
- **Suphx O0 executable implementation is pushed, without freeze or training
  ...
  1,030 passed / 27 skipped. Independent re-review must pass before the
...
| **T1 / Lane C Suphx O0 — IMPLEMENTED / RE-REVIEW REQUIRED / NO RUN** | Test whether a full-information policy can learn before spending compute on feature removal | Preserve preflight SHA `4f0c3dd5…434` and exact O0 material commit `7b15338`; dose is 64 iterations per arm for the exact fixed three-seed ensemble across 128 deal clusters. Every witness now clears snapshot constraints and a full chronological engine replay, including successful-throw legality. Exact-root and machine-readable packet-PASS boundaries remain. Focused 25/25, adjacent 196/196 in both routes, broad ordinary 1,030 passed / 27 skipped. Re-review `7b15338`; on PASS freeze only, then independently hash-admit the packet before Mini training. |
