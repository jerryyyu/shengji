...
Last reconciled: 2026-08-12 03:28 EDT. This file is the active execution
...
| **P0 / S6 shuai-pai sourcing** | Always expose legal throws, but spend expensive search where the added action can plausibly beat the existing ballot. | **Broad preflight review open; narrow fallback implemented.** PR #41 `ea07efa` is exact-Air green. Candidates appear on 93.4% of leads. PR #45 found late oracle signal only in boss/near bundles. PR #47 `a693b11` therefore preserves the full source ballot while searching boss/near additions only: 1,283 versus 10,162 broad triggers across 10,895 leads, an 87.37% reduction with all phases/roles covered. This is score-free cost evidence, not strength. **Left:** broad reviewed preflight; if impractical, review/freeze the narrow equal-work packet and test utility. | Reviewed capacity result and either a viable broad equal-work screen or a reviewed narrower boss/near-first packet | Literal live ballot stays candidate zero. Treatment must improve over live and matched null; source coverage, cost reduction and oracle endgame value alone are not strength. |
| **P0 / pair-aware rollout** | Remember which higher pairs have been exhausted inside simulated continuations, so search recognizes when a low pair has become unbeatable rather than treating every rollout as memoryless. | **Parents reviewed; repaired packet ready.** Exact endgames were `+9.21875` points (LCB `+6.67570`); the lead-root census changed 1/24 actions; all eight pair-cap-only live states were positive at 3,000 common worlds. Self-audit caught the v1 packet's false 100-action assumption before review/gameplay. PR #46 now preserves v2 controller `2321790` and packet `ba0bb693…baa0b6`; 39 tests cover legal 84-action rounds. A 192-state incremental public-proof dose census is running on Air. **Left:** v2 packet PASS, one Air preflight, then choose a powered natural-dose successor or stop if traffic/cost cannot support one. | Reviewed score-free whole-round capacity result and an adequately powered treatment/null/champion design—or a quantified stop decision | Actor-available information only; no determinized hidden-hand leakage. Matched null does identical analysis/work and returns champion. Exact and high-N diagnostics motivate the lane but never establish whole-game strength. |
