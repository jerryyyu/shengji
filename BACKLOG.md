...
Last reconciled: 2026-08-12 02:23 EDT. This file is the active execution
...
| **P0 / S6 shuai-pai sourcing** | Always let search see a legal throw candidate on eligible early, middle and late leads, instead of silently omitting a high-upside Shengji tactic. | **Mechanism semantics passed; preflight review open.** PR #19 source `c78a2d8`; matched equal-work policy PR #39 `0bdebbc`; Air-bound v2 packet PR #41 `ea07efa`. All 27 exact-Air focused tests pass. A disjoint score-free DEV census added candidates on 10,201/10,924 leads (93.4%), so this is broad and potentially expensive. **Left:** reviewed preflight, actual move-change/capacity measurement, then either a viable fresh screen packet or a narrower search gate. | Reviewed, capacity-sized equal-work state screen against live and matched widening | Literal live ballot stays candidate zero. Treatment must improve over live and candidate-count-matched null; source coverage alone is not strength. |
