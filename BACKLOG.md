...
Last reconciled: 2026-08-12 07:37 EDT. This file is the active execution
...
| 2 | **MC hand-shape bury search: voids + shuai-pai** | The current heuristic mostly ranks individual cards. The strategic choice is the hand left behind: creating a void enables ruffs, while preserving pairs/tractors and legal shuai-pai can create future control. Points may identify some weak states, but should not define the ballot or objective. | On reusable DEV, guarantee candidate zero plus every feasible suit-void bury and diverse structure-preserving variants. Evaluate candidates with high-N paired MC continuations whose lead ballot includes S6 shuai-pai; report value by void, preserved pair/tractor/throw shape and kitty risk. Advance only a bounded trigger or robust ballot to whole-game play. |
