...
Last reconciled: 2026-08-12 03:05 EDT. This file is the active execution
...
| **P0 / S6 shuai-pai sourcing** | Always expose legal throws, but spend expensive search where the added action can plausibly beat the existing ballot. | **Preflight review open; exploration narrowed the hypothesis.** PR #41 `ea07efa` is exact-Air green. Candidates appear on 93.4% of DEV leads. PR #45 `4331064` then compared best new versus best live-ballot actions in 192 fresh four-card endgames: boss/near was `+0.0156` level utility (4W/4L/56T); whole plain `-0.1094` (0W); whole trump `-0.0625` (0W). This is perfect-information late action-set evidence, not strength. **Left:** reviewed preflight for natural policy-change/capacity dose; if broad cost is poor, keep source coverage but test a boss/near-first search gate and separately explore earlier whole-suit tactics. | Reviewed capacity result and either a viable broad equal-work screen or a frozen narrower boss/near-first packet | Literal live ballot stays candidate zero. Treatment must improve over live and matched null; source coverage and oracle endgame value alone are not strength. |
| **P0 / pair-aware rollout** | Remember which higher pairs have already been exhausted inside simulated continuations, so search recognizes when a low pair has become unbeatable rather than treating every rollout as memoryless. | **Parents reviewed; complete-round packet ready.** Exact endgames were `+9.21875` points (LCB `+6.67570`); the lead-root census changed 1/24 actions. All eight pair-cap-only states in one live snapshot were positive at 3,000 common worlds (correlated exploratory mean `+5.00`). PR #46 `63ebd70` freezes a four-cluster score-free complete-round preflight with first-divergence dose and 2,048/8,192 cost projections. **Left:** external packet PASS, one Air preflight, then choose a powered natural-dose successor or stop if traffic/cost cannot support one. | Reviewed score-free whole-round capacity result and an adequately powered treatment/null/champion design—or a quantified stop decision | Actor-available information only; no determinized hidden-hand leakage. Matched null does identical analysis/work and returns champion. Exact and high-N diagnostics motivate the lane but never establish whole-game strength. |
