...
| **CLOSED / T4 mid/late Teacher hybrid** | Use the learned model as a proposal inside Monte Carlo search after trick five. | Terminal `SELECT_NONE`; treatment LCB `-0.00759` versus champion and `-0.03313` versus treatment-work-matched null. Learned targeting was not causal. The null's apparent win over champion is compute-confounded: +14.8% accepted worlds and +80.9% searches, so any widening confirmation must use champion, widening-at-champion-work and widening-at-null-work arms. | None for this recipe | No confirmation, retry, promotion or deployment. |
