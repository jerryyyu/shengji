...
Last reconciled: 2026-08-12 04:43 EDT. This file is the active execution
...
- Mini owns T4 until its supervisor-final seal. Short work under one hour
  ...
  use Air.
- Air is running the first externally authorized preflight: corrected pair-v3.
  S4 and S6 retain their untouched namespaces and wait for Air plus their own
  exact markers. Pair exploration resumes only after the preflight exits.
