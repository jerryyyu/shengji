...
Last reconciled: 2026-08-12 03:34 EDT. This file is the active execution
...
| **P0 / pair-aware rollout** | Remember which higher pairs have been exhausted inside simulated continuations, so search recognizes when a low pair has become unbeatable rather than treating every rollout as memoryless. | **Two concrete paths await review.** V1 exact endgames were `+9.21875` points (LCB `+6.67570`); PR #46 repaired packet `ba0bb693…baa0b6` now handles legal short rounds. PR #48's broader public opponent-cap census completed 192 states: 57 triggered; v1/v2 changed 9/10 roots; v2 added two changes and reverted one. **Left:** PR #46 packet PASS and one Air preflight; PR #48 source/result PASS and a separate capacity packet. Then power the more promising viable mechanism or stop quantitatively. | Reviewed score-free whole-round capacity result and an adequately powered treatment/null/champion design—or a quantified stop decision | Actor-available information only; no determinized hidden-hand leakage. Matched null does identical analysis/work and returns champion. Exact and high-N diagnostics motivate the lane but never establish whole-game strength. |
