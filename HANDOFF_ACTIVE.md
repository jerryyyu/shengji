...
Last reconciled: 2026-08-12 08:02 EDT.
...
| **Bury hand-shape exploration** | Draft PR #51 (`59cc2c6`) now crosses structured buries with existing, retained-pair and S6 first leads on common worlds. It is exploration-only and separates menu widening from bury-shape value; no job or policy is registered. | Optional lightweight semantics review while both hosts compute. After review, choose reusable DEV states and wait for free compute; this does not block T4/S4/S6/pair. |
