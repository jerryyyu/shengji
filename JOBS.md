...
| **Performance Cloud** | bounded performance engineering | **AVAILABLE / PERFORMANCE-ONLY.** Corrected compatibility receipt PR #75 `90c5630` and prepared-world PR #77 `0381081` await external review. The latter measured 2.62% lower wall time across six fresh exact-head pairs with normalized decisions, RNG, work and transcripts unchanged; the older 3.37% mixed-revision claim is retired. The trick-state cache is rejected: its correctness-safe repair was 10.56% slower on six fresh normalized rounds. The next bounded Memory-reuse exploration may use this host. S5 cannot: its old admission is spent and no retry exists. |
