...
1. **Pull status** — every running training/duel/generation job: PID + CPU
   (is it alive and working?), snapshots landed, probe/duel results since
   yesterday. Surface anything stalled or silently dead.
