...
| 2026-09-09 | Hybrid bury DEV / integration | 1,976 deals: +0.03644 utility `[+0.01164,+0.06024]` and +1.62 pp wins `[+0.56,+2.68]` vs heuristic; hybrid vs MC unresolved | PR323 `ec7f27ad`; compact `fd6bb411`, source `3cd27716`; planned 2s cooperative deadline + heuristic fallback. Kitty bonus ≥80: 4 hybrid vs 0 heuristic. Research had no deadline/fallback; no full-round speedup claim. Current release 21 remains heuristic bury. |
...
separate from the exact speedup. The merged optimization is available to the
W32 play path; current release 21 still uses heuristic bury and the separate
hybrid bury deployment remains pending.
