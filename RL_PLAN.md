...
| `rl_data/pilot_dev512.v5.json` | 512 unique deals; hash `097ea3851cd3bb9c`; bands 170/171/171; size 0/72/98, 11/131/29, 152/19/0; roles 85/85, 86/85, 86/85; source 129/41/0, 17/154/0, 0/1/170 | DEV worksheet for the lead-ballot design screen. Frozen from clean `759398b` by a fail-closed freezer: size now DRIVES deal selection, and a shortage or replay error publishes nothing instead of a short file. | **0/512 scored, awaiting Codex gate PASS.** Do not score or train on it until then. Supersedes v4 (`1cab080956d038b3`), whose selection followed corpus insertion order and whose source mix therefore differed between DEV and CALIB; v4 is retained only as a test negative control. |
| `rl_data/pilot_calib512.v5.json` | 512 unique deals, disjoint from DEV; hash `00ca4de1915d8c4f`; identical band/size/role allocation | Untouched holdout to judge exactly one frozen DEV-selected design. No action labels or scores. | **UNTOUCHED.** Do not tune, train, or score. Supersedes v4 (`8c55b3f809d43992`). |
