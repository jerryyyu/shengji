...
("G1: grid trunk (suit x level table) on M1's recipe, 176k","1bcbb47f","2026-09-14","v2",330,"3e-4","176k","25,388,708","0.54952","0.0308",
 "","","SCREENING","G1 (#411): grid trunk on M1's recipe, 644,423 params; val_ce 0.54952 = -0.048 vs M1, the largest offline step yet; capped screen running (v13)"),
...
PARAMS = {"3cb9cd62": 644568, "0ba58f0f": 623079, "dd85a21d": 656943, "1bcbb47f": 644423}
