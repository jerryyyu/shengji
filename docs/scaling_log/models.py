...
("M1: two heads on the S-d4 cell, 176k","3cb9cd62","2026-09-13","v2",330,"3e-4","176k","25,388,708","0.59746","0.0298",
 "","","5w +0.0174 [-0.0057, +0.0404]","M1 (#373): outcome head as proposer 5w not large, extending; search head as proposer WORSE, head-vs-head -0.0261 [-0.0500, -0.0022] excludes zero"),
