...
("M1: two heads on the S-d4 cell, 176k","3cb9cd62","2026-09-13","v2",330,"3e-4","176k","25,388,708","0.59746","0.0298",
 "","","+0.0184 [+0.0007, +0.0360]","M1 (#373): outcome head ten windows just clear zero (nominal CI, shared control, extend-on-positive); search head worse: paired contrast -0.0261"),
