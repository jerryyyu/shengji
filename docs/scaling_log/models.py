...
("M1: two heads on the S-d4 cell, 176k","3cb9cd62","2026-09-13","v2",330,"3e-4","176k","25,388,708","0.59746","0.0298",
 "","","5w +0.0174 [-0.0057, +0.0404]","M1 (#373): S-d4-176k cell + search-mean head; outcome head as proposer: 5w not large (MDE80 0.033), above +0.015 so extending; search head pending"),
...
PARAMS = {"3cb9cd62": 644568, "0ba58f0f": 623079}
