...
("smean-96k","8a6d5260","2026-09-12","v2",512,"3e-4","96k","14,077,520","1.67515","0.0353",
 "","","5w +0.0165 [-0.0092, +0.0422]","#340 arm: FIVE windows sealed 09-13 04:51 ET on the cloud lane (seeds 13260910..13660910 vs vol96k): +0.0165 [-0.0092, +0.0422], tau 0.0072, MDE80 0.0367 -- crosses zero (not large), point ABOVE the +0.015 extension line so seeds 13760910..14160910 are queued next on the same lane (ten-window readout to follow); offline third check: confident-pair sign agreement with the search +0.046 [+0.035, +0.058] over the leader (room-log), +0.029 [+0.009, +0.047] (luna);  leader recipe + --target search-mean (ramp(E[points]) surrogate, sidecar v2) + select on val_rank_regret; best epoch 5/8; realised val_ce 1.675 by construction (two-point targets); regret@4 0.0353 beats the leader's 0.0381 and clears the pre-registered <= 0.0361; wall 5,412 s vs vol96k's 9,591 s with #346/#347 (candidate pass 1,570 s vs 3,523 s)"),
