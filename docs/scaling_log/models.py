...
("M3: encoder v4 + two heads on the S-d4 cell, 176k","dd85a21d","2026-09-14","v4",330,"3e-4","176k","25,388,708","0.59689","0.0316",
 "","","5w +0.0260 [+0.0025, +0.0495]","M3 = M2 + the search-mean head: 0.59689 = programme best; five capped windows clear zero (nominal), extending; + throw policy paired -0.0168, null"),
