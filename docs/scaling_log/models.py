...
("M3: encoder v4 + two heads on the S-d4 cell, 176k","dd85a21d","2026-09-14","v4",330,"3e-4","176k","25,388,708","0.59689","0.0316",
 "","","QUEUED","M3 = M2 + the search-mean head, select on the outcome head: 0.59689 = programme best, -0.0006 vs M1 (v4 adds nothing offline); capped combo screen v9"),
("M1: two heads on the S-d4 cell, 176k","3cb9cd62","2026-09-13","v2",330,"3e-4","176k","25,388,708","0.59746","0.0298",
 "","","+0.0184 [+0.0007, +0.0360]","M1 (#373): outcome head ten windows just clear zero (shared-control caveat); search head the worse proposer: paired common-opponent contrast -0.0261"),
...
PARAMS = {"3cb9cd62": 644568, "0ba58f0f": 623079, "dd85a21d": 656943}
