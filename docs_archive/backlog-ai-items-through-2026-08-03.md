# Backlog AI section, archived 2026-08-03 23:15

Superseded by the rewritten AI section in BACKLOG.md. Kept because several
entries carry the reasoning behind a rejection (ANTICIPATE_FEED, the
compiled-core plan, the AWAC design) that the short form only names.
