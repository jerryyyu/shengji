# HANDOFF_ACTIVE.md historical body through 2026-09-03

Rotated losslessly out of `HANDOFF_ACTIVE.md` on 2026-09-04 (PR #195). The
text below is byte-for-byte the former body from `## Priority and authority`
to end of file. It is history for reconstruction only and carries no authority.
