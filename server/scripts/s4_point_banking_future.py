...
measurement, and cumulative aggregation.  The companion Air controller owns
...
PACKET_SCHEMA = "s4-point-banking-future-air-packet-v1"
PACKET_REVIEW_SCHEMA = "s4-point-banking-future-air-review-v1"
PACKET_REVIEW_MARKER = "S4_POINT_BANKING_FUTURE_AIR_V1_REVIEW "
ADMISSION_SCHEMA = "s4-point-banking-future-air-admission-v1"
RECEIPT_SCHEMA = "s4-point-banking-future-air-receipt-v1"
...
PREFLIGHT_RUN_ID = "s4-point-banking-future-preflight-239b-v1"
...
def require_receipt(path: Path, expected_sha256: str, *,
    ...
    controller_path = REPO / "server/scripts/s4_point_banking_future_air.py"
    ...
    if (set(packet) != packet_fields
            ...
            "server/scripts/s4_point_banking_future_air.py"
