#!/usr/bin/env python3
"""Pre-import launcher for the score-redacted Suphx O0 runtime preflight."""
...
def require_preimport_environment(environment=os.environ) -> None:
    ...
    if problems:
        raise SystemExit(
            "Suphx O0 runtime preflight refused before import: "
            + "; ".join(problems))
...
def main(argv: list[str] | None = None) -> int:
    ...
    from shengji.rl.suphx_o0_preflight import cli_main
