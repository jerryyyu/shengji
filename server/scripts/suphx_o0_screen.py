#!/usr/bin/env python3
"""Pre-import launcher for the frozen Suphx O0 oracle-acquisition screen."""
...
def require_preimport_environment(environment=os.environ) -> None:
    ...
    if problems:
        raise SystemExit(
            "Suphx O0 screen refused before import: "
            + "; ".join(problems))
...
def main(argv: list[str] | None = None) -> int:
    ...
    from shengji.rl.suphx_o0_screen import cli_main
