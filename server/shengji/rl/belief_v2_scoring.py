...
class V2DecisionScoringPool:
    ...
    def score(
        ...
        try:
            ...
            # repository still tests 3.12.  Fixed batches retain the same
            # bounded 2x-worker in-flight population on every supported
            # interpreter without eagerly queueing a complete 128-decision
            # round.
