...
_CAPACITY_REOPEN_MESSAGE_CODES = {
    ...
    "process trace payload drift": "process_trace_drift",
    "process trace operation drift": "process_trace_drift",
    "process trace error response drift": "process_trace_drift",
    "process observe/wait request drift": "process_trace_drift",
    "process observation response drift": "process_trace_drift",
    "process observation status drift": "process_trace_drift",
    "process decision observation drift": "process_trace_drift",
    ...
    "process rollout request drift": "process_trace_drift",
    "process rollout response drift": "process_trace_drift",
    "process rollout result drift": "process_trace_drift",
    "process rollout budget drift": "process_trace_drift",
    "process rollout utility drift": "process_binding_drift",
    "process play trace drift": "process_trace_drift",
    "process play completion drift": "process_binding_drift",
    ...
    "stop hook binding drift": "process_binding_drift",
    "process identity drift": "process_provenance_drift",
    "process command identity drift": "process_provenance_drift",
    "planner identity schema drift": "process_provenance_drift",
    "sandbox identity drift": "sandbox_drift",
