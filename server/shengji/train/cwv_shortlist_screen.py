...
def main(argv=None):
    ...
    parser.add_argument("--production-multiplier", type=int, choices=(1, 3, 10), default=1)
    parser.add_argument("--target-wall-multiplier", type=int, choices=(1, 3, 10, 20), default=1)
